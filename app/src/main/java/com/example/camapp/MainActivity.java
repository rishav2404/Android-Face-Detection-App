...
import com.example.camapp.image.ImageClassificationActivity;
import com.example.camapp.object.FaceDetectionActivity;
...
public class MainActivity extends AppCompatActivity implements AlgoListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayList.add(new Algo(R.drawable.baseline_portrait_black_48, "Face Distance Measure", FaceDetectionActivity.class));
